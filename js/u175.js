    ...
    a.Utils.Pixel.prototype = $.extend({}, {
        fire: function() {
            ...
            if (!b) {
                ...
                if (b.kl) {
                    c.push({
                        kl: a.settings.get("kl")
                    })
                }
                if (b.kp) {
                    c.push({
                        kp: a.settings.get("kp")
                    })
                }
                f = b.once;
                e = b.dedupe
        ...
        sanitizeUrl: function(b) {
            return b.replace(/^\/|\/$/, "").replace(/[^a-z0-9_-]+/ig, "-")
        },
        _send: function(m, c) {
            var o = Math.ceil(Math.random() * 10000000),
                r = "",
                p = "",
                s;
            ...
            if (a.opensearch && a.opensearch.installed.version) {
                p += "&atb=" + a.opensearch.installed.version;
                if (a.opensearch.installed.atbVariant) {
                    p += "&atbva=" + a.opensearch.installed.atbVariant
                }
                if (a.opensearch.installed.variant) {
                    p += "&va=" + a.opensearch.installed.variant
                }
            }
            if (a.duckbar && a.duckbar.hasSideModules()) {
                p += "&sm=" + a.duckbar.getSideModuleInfo().join(",")
            }
            if (a.duckbar && a.duckbar.hasOrganicModules()) {
                p += "&om=" + a.duckbar.getOrganicModuleInfo().join(",")
            }
            if (a.page && a.page.mobileUIExperiment) {
                p += "&uiexp=" + a.page.mobileUIExperiment
            }
            if (c.once) {
                var n = p;
                if (c.dedupe) {
                    var f = new RegExp("&?" + c.dedupe + "=[^&]+");
                    n = p.replace(f, "")
                }
                var k = r + n;
                if (this._sentPixels.indexOf(k) > -1) {
                    return
                }
                this._sentPixels.push(k)
            }
            if (a.deep) {
                if (a.deep.cde) {
                    p += "&cde=" + a.deep.cde
                ...
                if (a.deep.nde) {
                    ...
                    p += "&q=" + a.get_query_encoded()
                }
            }
            if (a.duckpan || a.device && a.device.isDDGIgnore) {
                return
            }
            var b;
            try {
...
! function(b) {
    ...
    a.prototype = {
        _onError: function(o, c, g, n, j, m) {
            if (!o || o === ": " || o.match(/Script error|Cannot read property \'style\'|atomicFindClose|bestpriceninja|ModifyLinkTargets|browserToolsLoaded|__gCrWeb|mobiGetClick|savingsslider|DealPly|processSiteSource|symcBFPerform|Papa_|ByTagName\(\'video\'|setTimeout[0-9]+ is undefined/)) {
                return
            }
            if (!c || !c.match(/^http/i) || c.match(/checkpoint|main\.js/)) {
                return
            }
            if (o.match("contentWindow") && b.device.label === "Android") {
                return
            }
            var f = (m) ? m.toLowerCase() : this._getCategory(c, g);
            try {
                var h = {
                ...
                b.pixel.fire("jse", f, h)
            } catch (i) {
                var k = Math.ceil(Math.random() * 10000000);
                $('<img src="/t/jse_u?' + k + "&msg=infinite%20loop%20in%20onerror%3A%20" + i.message + '"/>')
            }
        },
        _getCategory: function(c, g) {
            var e;
            if (c.match(/\/\?q=/)) {
                e = "view";
                if (g && g > 1) {
                ...
                if (c.match(/\/share\/spice/)) {
                    e = "spice"
                } else {
                    if (c.match(/\/share\/goodie/)) {
                        e = "goodie"
                    } else {
                        if (c.match(/\/js\/spice/)) {
                            e = "spiceupstream"
    ...
    b.errorHandler = new a()
}(DDG);
! function(a) {
    a.embed = {
        callback: null,
        id: "embed",
        _hasValidResult: function(b) {
            return b && b.description && b.image && b.provider && b.title && b.icon && b.url && b.tab_name
        },
        add: function(b) {
            if (!b || !this._hasValidResult(b)) {
                a.duckbar.failed("embed");
                return
            }
            Spice.add({
                id: this.id,
                ...
                signal: b.signal,
                meta: {
                    sourceName: b.provider,
                    sourceUrl: b.url,
                    sourceIconUrl: b.icon
                },
                templates: {
                    group: "info",
                    options: {
...
! function(b, a) {
    ...
    var h, e = 0,
        ...
        f = function() {
            ...
            h = window.soundManager = new SoundManager();
            h.url = "/soundmanager2/swf";
            h.flashVersion = 9;
            h.useFlashBlock = false;
            h.useHTML5Audio = true;
    ...
    var c = b.audio = {
        ...
        play: function(m, i, k) {
            ...
            k = k || {};
            var j = h.getSoundById(m);
            if (j) {
                j.play(k)
            } else {
                k.onloadstart && k.onloadstart();
                j = h.createSound($.extend(k, {
                    id: m,
                    url: i
                }))
            }
...
! function(b) {
    var e = {
            ...
            mapsgl: {
                require: function() {
                    return (window.mapboxgl && window.mapboxgl.Map) || c("mapsgl")
                },
                load: function() {
                    nrc("/js/mapbox/mapbox-gl.v0.40.0.css", 1);
                    nrj("/js/mapbox/mapbox-gl.v0.40.0.js", 1)
                }
            },
            settings: {
                require: function() {
            ...
            velocity: {
                ...
                load: function() {
                    nrj("/js/velocity-1.5.0.min.js", 1)
                }
            },
            flashDetect: {
                require: function() {
            ...
            "chart.js": {
                ...
                load: function() {
                    nrj("/js/Chart-2.6.0.min.js", 1)
                }
            },
            pikaday: {
                require: function() {
                    return $.fn.pikaday || c("pikaday")
                },
                load: function() {
                    nrj("/js/Pikaday-1.4.0/pikaday.min.js", 1);
                    nrc("/js/Pikaday-1.4.0/css/pikaday.min.css", 1)
                }
            },
            prettydiff: {
                require: function() {
                    return window.prettydiff || c("prettydiff")
                },
                load: function() {
                    nrj("/js/prettydiff.js", 1)
                }
            },
            jsonlint: {
                require: function() {
                    return window.jsonlint || c("jsonlint")
                },
                load: function() {
                    nrj("/js/jsonlint.js", 1)
                }
            },
            extensionsuccess: {
                require: function() {
                    return window.extensionsuccess || c("extensionsuccess")
                },
                load: function() {
                    nrj("/js/extensionsuccess.min.js?v=6", 1)
                }
            },
            prettify: {
                require: function() {
                    return window.prettyPrint || c("prettify")
                },
                load: function() {
                    nrc("/js/highlight/tomorrow.css?v=2");
                    nrc("/js/highlight/tomorrow-night-eighties.css");
                    nrj("/js/highlight/prettify.min.js", 1)
                }
            },
            "sass.js": {
                require: function() {
                    return window.Sass || c("sass.js")
                },
                load: function() {
                    nrj("/js/sass.js/sass.sync.min.js")
                }
            },
            "js-beautify": {
                require: function() {
                    return window.js_beautify || c("js-beautify")
                },
                load: function() {
                    nrj("/js/js-beautify/beautify.min.js")
                }
            },
            "html-beautify": {
                require: function() {
                    return window.html_beautify || c("html-beautify")
                },
                load: function() {
                    nrj("/js/js-beautify/beautify-html.min.js")
                }
            },
            "math.js": {
                require: function() {
                    return window.math || c("math.js")
                },
                load: function() {
                    nrj("/js/math-3.13.3.min.js")
                }
            },
            "twitter-text": {
                require: function() {
                    return window.twttr || c("twitter-text")
                },
                load: function() {
                    nrj("/js/twitter-text-2.0.0.min.js")
                }
            },
            hammer: {
                require: function() {
                    return window.Hammer || c("hammer")
                },
                load: function() {
                    nrj("/js/build/hammer-v2.0.8.min.js")
                }
            }
        },
        c = function(g) {
...
! function(b) {
    var a = b.Utils;
    a.BackData = function(c) {
        this.$hiddenEl = c
    };
    a.BackData.prototype = $.extend({}, {
        set: function(f, e) {
            var c = f;
            if (e) {
                c += "|" + JSON.stringify(e)
        ...
        getId: function() {
            return this._getVal().split("|")[0]
        },
        getData: function() {
            if (this._cachedData) {
                return this._cachedData
            }
            var g = this._getVal().split("|")[1],
                c;
            try {
                c = JSON.parse(g)
            } catch (f) {
    ...
    b.backData = new b.Utils.BackData($("#state_hidden"))
}(DDG);
! function(a) {
    a.Utils.History = function(h) {
        ...
        var b, e = /\+/g,
            c = /([^&=]+)=?([^&]*)/g,
            g = function(j) {
                return decodeURIComponentSafe(j.replace(e, " "))
            },
            i = window.location.search + window.location.hash,
            f = i.substring(1);
        while (b = c.exec(f)) {
            this.curState[g(b[1])] = g(b[2])
        }
        this._deviceSupportsHistory = this._history && this._history.pushState && this._history.replaceState
    };
    a.Utils.History.prototype = $.extend({}, EventEmitter2.prototype, {
        enablePushState: function(b) {
            if (this._deviceSupportsHistory && !this._pushStateEnabled) {
                this._pushStateEnabled = true;
                this._shouldPushFn = b;
                window.onpopstate = this._onPopState.bind(this)
            }
        },
        get: function(b) {
            return this.curState[b]
        },
        ...
        set: function(b, f, e) {
            ...
            this.curState[b] = f;
            this._updatePath(this._shouldPushState(b, f), e)
        },
        clear: function() {
            ...
            for (var c = 0; c < b.length; c++) {
                delete this.curState[b[c]];
                if (this._shouldPushState(b[c])) {
                    f = true
                }
            }
            this._updatePath(f, e)
        },
        clearNamespace: function(e, c) {
            var b = false;
            for (var f in this.curState) {
                if (this.curState.hasOwnProperty(f)) {
                    if (f.indexOf(e) === 0) {
                        delete this.curState[f];
                        if (this._shouldPushState(f)) {
                            b = true
                        }
                    }
                }
            }
            this._updatePath(b, c)
        },
        setComposite: function(e, i, c, g) {
            var b = this.get(e),
                h = {},
                f;
            if (b) {
                f = this._deserializeComposite(b);
                f[i] = c
            } else {
                f = {};
                f[i] = c
            }
            h[e] = this._serializeComposite(f);
            this.set(h, g)
        },
        getComposite: function(c, f) {
            var b = this.get(c),
                e;
            if (!b) {
                return
            }
            e = this._deserializeComposite(b);
            return e[f]
        },
        clearComposite: function(c, h, f) {
            var b = this.get(c),
                e;
            if (!b) {
                return
            ...
            if ($.isEmptyObject(e)) {
                ...
                var g = {};
                g[c] = this._serializeComposite(e);
                this.set(g, f)
            }
        },
        _updatePath: function(c, b) {
            var e = this.path + "?" + $.param(this.curState);
            if (this._curPath === e) {
                return b && b()
            }
            this._curPath = e;
            ...
            if (this._deviceSupportsHistory && a.settings.isDefault("kg")) {
                clearTimeout(this._stateTimeout);
                this._pushing = this._pushing || c;
                this._stateTimeout = setTimeout(function() {
                    if (this._pushing) {
                        this._history.pushState(this.curState, this, this._curPath)
                    } else {
                        this._history.replaceState(this.curState, null, this._curPath)
                    }
        ...
        _deserializeComposite: function(c) {
            var f = {},
                g = c.split(","),
                b;
        ...
        _serializeComposite: function(b) {
            var c = [];
            for (var e in b) {
        ...
        _shouldPushState: function(b, c) {
            if (this._popping || !this._pushStateEnabled || typeof this._shouldPushFn !== "function") {
                return false
            }
            return this._shouldPushFn(b, c)
        },
        _onPopState: function(b) {
            this._popping = true;
            this.emit("popstate", b);
            this._popping = false
        }
    });
    a.history = new a.Utils.History(window.history)
}(DDG);
! function(e) {
    var i = {},
        a = [],
...
! function(e) {
    var c = "is-touching",
        ...
        g = 20,
        a = 300;
    e.Utils.GestureRecognizer = function(i) {
        this.$el = i.el;
        this._lastMoves = [];
        if (Modernizr.touch) {
    ...
    e.Utils.GestureRecognizer.prototype = $.extend({}, EventEmitter2.prototype, {
        numTouches: 0,
        reset: function() {
            e.$doc.off("touchmove.gestures");
            e.$doc.off("touchend.gestures");
            this.$el.removeClass(c);
            delete this._startX;
            delete this._startY;
            delete this._startTime;
            delete this._pinchDistance;
            delete this._pinchDelta;
            delete this._multitouch;
            delete this._axis;
            delete this._direction;
            this._lastMoves = []
        },
        _pan: function(s, r) {
            this._deltaX = this._x ? s - this._x : 0;
            this._deltaY = this._y ? r - this._y : 0;
            this._x = s;
            this._y = r;
            if (!this._startX) {
            ...
            this._distX = this._x - this._startX;
            this._distY = this._y - this._startY;
            this._lastMoves.push([s, r, j]);
            if (this._lastMoves.length > b) {
                this._lastMoves.shift();
                var i = this._lastMoves[0],
                    o = i[0],
                    n = i[1],
                    k = i[2],
                    m = j - k,
                    q = this._x - o,
                    p = this._y - n;
                this._velocityX = m ? q / m : 0;
                this._velocityY = m ? p / m : 0;
                this._axis = Math.abs(q) > Math.abs(p) ? "x" : "y";
                this._direction = this._axis === "x" ? q >= 0 ? "right" : "left" : p >= 0 ? "down" : "up"
            }
            this._multitouch = false
        },
        _pinch: function(j, m, i, k) {
            var n = this._getDistance(j, m, i, k);
            if (!this._pinchDistance) {
                this._pinchDistance = n
            }
            this._pinchDelta = Math.abs(n / this._pinchDistance);
            this._pinchDistance = n;
            this._multitouch = true
        },
        _getDistance: function(m, o, j, n) {
            var k = m - j,
                i = o - n;
            return Math.sqrt(k * k + i * i)
        },
        _getEventData: function(i) {
            return {
                ...
                deltaX: this._deltaX,
                deltaY: this._deltaY,
                pinchDist: this._pinchDistance,
                pinchDelta: this._pinchDelta
            }
        },
        _getNumTouches: function(i) {
            var j = i.originalEvent;
            return j && j.touches && j.touches.length
        },
        _handleTouches: function(i) {
            var j = i.originalEvent;
            if (j && j.touches && j.touches.length) {
                if (j.touches.length > 1) {
                    this._pinch(j.touches[0].clientX, j.touches[0].clientY, j.touches[1].clientX, j.touches[1].clientY)
                } else {
                    if (!this._multitouch) {
                        this._pan(j.touches[0].clientX, j.touches[0].clientY)
                    }
                }
            } else {
                this._pan(i.clientX, i.clientY)
            }
        },
        _onTouchStart: function(k) {
            this.numTouches = this._getNumTouches(k) || 1;
            if (!this._startTime) {
                this.$el.addClass(c);
                this._startTime = new Date().getTime();
                e.$doc.on("touchmove.gestures", this._onTouchMove.bind(this));
                e.$doc.on("touchend.gestures", this._onTouchEnd.bind(this))
            }
            if (!k.target || k.target.nodeName !== "A") {
                k.preventDefault()
            }
            this._handleTouches(k);
            var i = this._multitouch ? "pinchstart" : "panstart",
        ...
        _onTouchMove: function(k) {
            ...
            this.numTouches = this._getNumTouches(k) || 1;
            this._handleTouches(k);
            var i = this._multitouch ? "pinchmove" : "panmove",
                j = this._getEventData(k);
            this.emit(i, j)
        },
        _onTouchEnd: function(p) {
            this.numTouches = this._getNumTouches(p) || 0;
            if (this.numTouches > 0) {
                return
            }
            var i = Math.abs(this._axis === "x" ? this._distX : this._distY),
                o = this._axis === "x" ? this._velocityX : this._velocityY,
                k = i < g,
                j = i > f || o > h,
                n = this._getEventData(p);
            if (this._multitouch) {
                this.emit("pinchend", n)
            } else {
                if (j && !k) {
                    n.swiped = true;
                    this.emit("swipe", n)
                    ...
                    if (k) {
                        ...
                        if (this._lastTapTime && (m - this._lastTapTime) < a) {
                            this.emit("double-tap", n);
...
! function(b) {
    var f = ["Detail", "GridTiles"],
        ...
        h = ["VerticalLinks"],
        c = {};
    b.Utils.TabViewBuilder = function() {};
    b.Utils.TabViewBuilder.prototype = $.extend({}, {
        build: function(j) {
            this.model = j.model;
            this._viewRoot = b.Views.AnswerBar.Answers;
            if (this.model.view) {
                this._availableViews = [this.model.view]
            } else {
                if ($.isArray(this.model.views)) {
                    this._availableViews = this.model.views
                } else {
                    if (this.model.isModule) {
                        this._availableViews = g[this.model.id] || i;
                        this._viewRoot = b.Views.Modules
                    } else {
                        if (this.model.isVertical) {
                            this._availableViews = c[this.model.id] || h;
                            this._viewRoot = b.Views.Verticals
                        } else {
                            this._availableViews = e[this.model.id] || f
                        }
                    }
                }
            }
            var k = this._getValidClass();
            if (!k) {
                return false
            }
            return new k({
                model: this.model,
                viewModel: j.viewModel || this._getViewModel(),
                appendTo: j.appendTo,
                events: j.events
            })
        },
        _getValidClass: function() {
            if (typeof this._viewIndex === "undefined") {
                this._viewIndex = 0
            } else {
                if (!this._availableViews[this._viewIndex + 1]) {
                    return false
                }
                this._viewIndex++
            }
            if (!this._isCurrentClassValid()) {
                return this._getValidClass()
            }
            return this._getCurrentViewClass()
        },
        _isCurrentClassValid: function() {
            var j = this._getCurrentViewClass(),
                k = j.prototype.isValid.call({
                    requiredTemplates: j.prototype.requiredTemplates,
                    maxItems: j.prototype.maxItems,
                    model: this.model
                });
            return k
        },
        _getCurrentViewClass: function() {
            var j = this._availableViews[this._viewIndex];
            return this._viewRoot[j]
        },
        _getViewModel: function() {
            if (!this.model.isModule) {
                return
            }
            var j = b.Models.Modules[this._availableViews[this._viewIndex]];
            if (!j) {
                return
            }
            var k = this.model.data;
            if (a[this.model.id]) {
                k = {
                    data: k
                }
            }
            return new j($.extend(true, {
                minimizeHeight: !this.model.isSideModule
            }, k))
        }
    })
}(DDG);
...
! function(a) {
    a.Utils.LocalAPIWrapper = function() {};
    a.Utils.LocalAPIWrapper.prototype = {
        getMapsResponse: function(c) {
            var e = this._getMapsSource(c),
                b = {};
            if (!c.features || !c.features.length) {
                return b
            }
            if (e === "mapbox") {
                b = this._getMapboxMapsResponse(c)
            } else {
                if (e === "wikipedia") {
                    b = this._getWikipediaMapsResponse(c)
                }
            }
            return b
        },
        getPlacesResponse: function(c) {
            var b = {};
            if (!c.results || !c.results.length) {
                return b
            }
            return {
                source: c.results[0].engine,
                url: c.more_at + c.query,
                signal: c.signal,
                results: c.results.map(function(e) {
                    return this._getPlaceItemResponse(e)
                }.bind(this))
            }
        },
        _getMapboxMapsResponse: function(b) {
            var c = ["directions", "map", "maps", "st", "street", "ave", "avenue", "dr", "drive", "pl", "place", "apt", "suite", "latitude", "longitude", "zip", "code", "postal"],
                e = b.features.shift();
            if (e.relevance < 0.9 && !(e.place_name && a.isRelevant(e.place_name.toLowerCase(), c))) {
                return {
                    src: "mapbox",
                    results: []
                }
            ...
            return {
                src: "mapbox",
                results: [this._getMapboxMapsItemResponse(e)]
            }
        },
        _getPlaceItemResponse: function(b) {
            var c = {};
            if (b.id && b.id.length) {
                c.itemId = b.id
            }
            ...
            if (b.address && b.address.length) {
                c.address = b.address
            }
            if (b.address_lines && b.address_lines.length) {
                c.addressLines = b.address_lines
            }
            if (b.phone && b.phone.length) {
                c.phone = b.phone
            }
            var e = b.coordinates;
            if (e) {
            ...
            if (b.photoURL && b.photoURL.length) {
                c.imageURL = b.photoURL
            } else {
                if (b.name) {
                    c.imageURL = "/?q=" + encodeURIComponent(b.name) + "&ia=images&iax=images"
                }
            }
            if (b.menu && b.menu.length) {
                c.menuURL = b.menu
            }
            if (b.price && a.isNumber(b.price)) {
                c.price = b.price
            }
            if (b.hours) {
                c.hours = b.hours
            }
            if (b.returned_categories && b.returned_categories.length) {
                c.categories = b.returned_categories.map(function(f) {
                    return {
                        id: f[1],
                        name: f[0]
                    }
            ...
            if (b.rating && a.isNumber(b.rating)) {
                c.rating = b.rating
            }
            if (b.engine === "Yelp" && b.rating) {
                c.ratingImage = "/assets/yelp-stars/v3/" + b.rating + ".png";
                c.ratingImageRetina = "/assets/yelp-stars/v3/" + b.rating + "@2x.png"
            }
            if (b.reviews && a.isNumber(b.reviews)) {
                c.reviewCount = b.reviews
            }
            if (b.review_detail && b.review_detail.length && b.url && b.url.length) {
                if (b.engine === "Yelp") {
                    c.reviewURL = b.url + "&hrid=" + b.review_detail[0].id
                } else {
                    if (b.engine === "TripAdvisor") {
                        c.reviewURL = b.url + "#REVIEWS"
                    }
                }
                c.reviews = b.review_detail.map(function(h) {
                    var f = {};
                    if (h.id && h.id.length) {
                        f.id = h.id
                    }
                    if (h.rating && a.isNumber(h.rating)) {
                        f.rating = h.rating
                    }
                    if (b.engine && b.engine === "Yelp") {
                        f.ratingImage = "/assets/yelp-stars/v3/" + h.rating + ".png";
                        f.ratingImageRetina = "/assets/yelp-stars/v3/" + h.rating + "@2x.png"
                    }
                    if (h.time_created && a.isNumber(h.time_created)) {
                        f.timeCreated = h.time_created
                    }
                    if (b.url && b.url.length) {
                        if (b.engine === "Yelp") {
                            f.url = f.id ? b.url + "&hrid=" + f.id : b.url
                        } else {
                            if (b.engine === "TripAdvisor") {
                                f.url = b.url + "#REVIEWS"
                            }
                    ...
                    if (g) {
                        ...
                        if (g.name && g.name.length) {
                            f.user.name = g.name
                        }
                        if (g.image_url && g.image_url.length) {
                            f.user.image = g.image_url
                        }
                        if (g.id && g.id.length && b.engine === "Yelp") {
                            f.user.url = "https://www.yelp.com/user_details?userid=" + g.id
                        }
                    }
                    return f
                })
        ...
        _getMapboxMapsItemResponse: function(h) {
            var f, e, c = {};
            if (h.context) {
                h.context.forEach(function(i) {
                    var j = i.id.split(".")[0];
                    c[j] = i.text
                })
            }
            if (h.address || h.place_type && h.place_type[0] == "address") {
                var g = h.place_name.split(",");
                f = g[0];
                if (c.place && c.region && c.place !== c.region) {
                    e = c.postcode ? c.place + ", " + c.region + " " + c.postcode : c.place + ", " + c.region;
                    e = c.locality ? c.locality + ", " + e : e
                } else {
                    if (c.place) {
                        e = c.postcode ? c.place + " " + c.postcode : c.place;
                        e = c.locality ? c.locality + ", " + e : e;
                        e = c.country ? e + ", " + c.country : e
                    } else {
                        if (c.region) {
                            e = c.region === h.name ? c.country : c.region + ", " + c.country
                        } else {
                            e = c.country
                        }
                    }
                ...
                if (c.place) {
                    f = c.place;
                    e = (c.place !== c.region) ? c.region : c.country
                } else {
                    if (c.region) {
                        if (name !== c.region) {
                            e = c.region
        ...
        _getWikipediaMapsResponse: function(b) {
            return {
                src: "wikipedia",
                results: b.features.map(function(c) {
                    return {
                        lat: c.center[1],
                        lon: c.center[0],
                        bbox: c.bbox,
                        name: c.place_name,
                        address: c.place_name
                    }
                })
            }
        },
        _getMapsSource: function(b) {
            if (b && b.features && b.query) {
                return "mapbox"
            } else {
                if (b) {
                    return "wikipedia"
    ...
    a.localAPI = new a.Utils.LocalAPIWrapper()
}(DDG);
! function(e) {
    var c = e.Utils,
        b = {
    ...
    c.Mapbox.prototype = {
        DEFAULT_ZOOM: 14,
        ACCESS_TOKEN: "pk.eyJ1IjoiZHVja2R1Y2tnbyIsImEiOiJiczA0MnE4In0.-Df8dM1SoUB2myaUu2_YdA",
        API_URL: "https://duckduckgo.com/mapboxapi",
        STATIC_IMG_API_URL: "https://proxy.duckduckgo.com/mapboxapi",
        ASSETS_ROOT: "/js/mapbox",
        canUseGL: function() {
            if (!this._canUseGL) {
                this._canUseGL = w.mapboxgl && w.mapboxgl.supported()
            }
            return this._canUseGL
        },
        setGLCredentials: function() {
            w.mapboxgl.accessToken = this.ACCESS_TOKEN;
            w.mapboxgl.config.API_URL = this.API_URL
        },
        getStyleId: function() {
            var h = this._getStyleName();
            return b[h]
        },
        getStyleUrl: function(j) {
            var i = this._getStyleName(j),
                h = this.ASSETS_ROOT + "/styles/mapbox.";
            h += b[i];
            if (j && (e.device.is2x || e.device.is3x)) {
                h += "@2x"
            }
            h += ".json?v=2";
            return h
        ...
        getMarkerLayer: function() {
            return {
                ...
                layout: {
                    ...
                    "icon-size": (e.device.is2x || e.device.is3x) ? 0.5 : 1,
                    "icon-offset": [0, -23]
                }
            }
        },
        getMarkerSource: function(h) {
            var i = {
        ...
        getMarkerIcon: function() {
            var h = this.ASSETS_ROOT + "/map-pin_circle";
            if (e.settings.isDarkTheme()) {
                h += "--blue"
            }
            h += e.device.is2x || e.device.is3x ? "@2x.png" : ".png";
            return h
        },
        getStaticImageURL: function(n) {
            var m = Math.round(n.width || g),
                i = Math.round(n.height || a),
                o = n.zoom || this.DEFAULT_ZOOM,
                h = n.markers.length > 1,
                k, j;
            j = n.markers.map(this._getMarkerString.bind(this, h));
            if (!h && n.markers[0].bbox) {
                j.push(this._getPolylineForBoundingBox(n.markers[0].bbox))
            }
            if (j.length > 1) {
                k = "auto"
            } else {
                k = [n.markers[0].lon, n.markers[0].lat, o, 0, 0].join(",")
            }
            return this.STATIC_IMG_API_URL + "/styles/v1/mapbox/" + this.getStyleId() + "/static/" + j.join(",") + "/" + k + "/" + m + "x" + i + (e.device.isRetina ? "@2x" : "") + "?attribution=false&logo=false&access_token=" + this.ACCESS_TOKEN
        },
        _getMarkerString: function(i, k, j) {
            var h = "pin-s";
            if (i) {
                h += "-" + (j + 1)
            }
            h += "+" + this.getMarkerColor();
            h += "(" + k.lon + "," + k.lat + ")";
            return h
        },
        _getPolylineForBoundingBox: function(i) {
            var h = window.polyline.encode([
                [i[1], i[0]],
                [i[3], i[2]]
            ]);
            return "path-1+fff-0+fff-0(" + h + ")"
        },
        _getStyleName: function(i) {
            var h;
            if (i) {
                h = "satellite"
            } else {
...
(function(b) {
    ...
    a.get_favicon_url = function(n) {
        if (!n || typeof n !== "string") {
            return
        }
        var j, c, q, g, m, h, o, f, i = "",
            p, e = /wikipedia|amazon|youtube|yelp|apple|vimeo|metrolyrics|spotify|wolfram|metrolyrics|wordnik|brainyquote|soundcloud/,
            k = /wikipedia/;
        q = /^.*?\/\/([^\/\?\:\#]+)/;
        g = q.exec(n);
        if (g && $.isArray(g)) {
        ...
        if (m) {
            m = m.toString();
            o = n.split(".");
            f = (o.length > 1) ? (o[o.length - 2] === m) : true;
            if (f) {
                if (a.settings && a.settings.updater && a.settings.updater.isDarkBg && k.test(m)) {
                    i = ".white"
                }
                h = a.is3x ? ".3x" : a.is2x ? ".2x" : "";
                c = "/assets/icons/favicons/" + m + i + h + ".png"
            }
        }
        if (!c) {
    ...
    a.strip_all_html = function(f) {
        var c = "(?:[^\"'>]|\"[^\"]*\"|'[^']*')*",
            e = new RegExp("<(?:!--(?:(?:-*[^->])*--+|-?)|script\\b" + c + ">[\\s\\S]*?<\/script\\s*|style\\b" + c + ">[\\s\\S]*?</style\\s*|/?[a-z]" + c + ")>", "gi"),
            g;
        while (f !== g) {
            g = f;
            f = f.replace(e, "")
...
DDG.Data.Settings = {
    ...
    directionSources: {
        "apple-maps-ios": {
            directionsURL: "maps://?daddr={{addr}}&near={{lat}},{{lng}}",
            faviconURL: "maps.apple.com",
            mapURL: "maps://?address={{addr}}&near={{lat}},{{lng}}",
            name: "Apple Maps",
            onDevices: ["isIDevice"]
        },
        "apple-maps-osx": {
            directionsURL: "http://maps.apple.com/?daddr={{addr}}&&near={{lat}},{{lng}}",
            mapURL: "http://maps.apple.com/?address={{addr}}&near={{lat}},{{lng}}",
            name: "Apple Maps",
            onDevices: ["isOSXMavericksAndUp"]
        },
        "bing-maps": {
            directionsURL: "https://bing.com/maps/default.aspx?rtp=~adr.{{addr}}&cp={{lat}}~{{lng}}&lvl=15",
            mapURL: "https://bing.com/maps/default.aspx?where1={{addr}}",
            name: "Bing Maps"
        },
        "google-maps": {
            directionsURL: "https://www.google.com/maps/dir//{{addr}}",
            mapURL: "https://maps.google.com?q={{addr}}",
            name: "Google Maps"
        },
        "here-maps": {
            directionsURL: "https://maps.here.com/directions/drive//{{addr}}:{{lat}},{{lng}}?map={{lat}},{{lng}},15,normal",
            faviconURL: "here.com",
            mapURL: "https://wego.here.com/?map={{lat}},{{lng}},5,normal",
            name: "HERE Maps",
            notOnDevices: ["isMobileDevice", "isIE9"]
        },
        osm: {
            directionsURL: "https://www.openstreetmap.org/directions?route=%3B{{lat}}%2C{{lng}}#map=15/{{lat}}/{{lng}}",
    ...
    headerBehaviors: {
        "1": {
            name: "On & Fixed",
            onDevices: ["hasFixedHeaderSupport"]
        },
        "-1": {
            name: "Off"
        },
    ...
    k18: {
        "default": "0",
        desc: "Changes whether the visited check mark is visible",
        name: "Result Visited Check Mark",
        type: "boolean"
    },
    k5: {
        "default": "-1",
    ...
    kao: {
        "default": "1",
        desc: "Show the privacy benefits of using DuckDuckGo on the homepage",
        name: "Homepage Privacy Tips",
        type: "boolean"
    },
    kap: {
        "default": "1",
        desc: "Show occasional reminders to sign up for the DuckDuckGo privacy newsletter",
        hideTitle: true,
    ...
    kaq: {
        "default": "1",
        desc: "Show sign up form for the DuckDuckGo privacy newsletter",
        name: "Privacy Newsletter",
        type: "boolean"
    },
    kax: {
        "default": "1",
        desc: "Show occasional reminders to add DuckDuckGo to your browser",
        hideTitle: true,
        name: "ATB Dismiss",
        type: "boolean"
    },
    ...
    kd: {
        "default": "1",
        desc: "In some older browsers it's necessary to redirect your clicks through our server to prevent Search Leakage. %sMore Info%s.",
        desc2: "<a href='https://duck.co/help/results/rduckduckgocom'>",
        desc3: "</a>",
        name: "Redirect (when necessary)",
        type: "boolean"
    },
    kf: {
        "default": "1",
    ...
    tabs: [{
        id: "general",
        name: "General",
        settings: ["kl", "kad", "break", "kp", "kz", "break", "kc", "kac", "kn", "k1", "kk", "kaj", "kam", "break", "kv", "break", "kak", "kax", "break", "kaq", "kap", "break", "kao"]
    }, {
        id: "theme",
        name: "Theme",
        settings: ["kae"]
        ...
        id: "appearance",
        name: "Appearance",
        settings: ["Page Appearance", "kt", "ks", "kw", "km", "k7", "break", "Header Appearance", "ko", "kj", "break", "Results Appearance", "ka", "k9", "kaa", "ku", "break", "k8", "kx", "ky", "kaf", "kai", "k18", "break", "kf"]
    }, {
        id: "privacy",
        name: "Privacy",
        settings: ["kh", "kg", "k5", "kd"]
    }]
};
! function(a) {
    a.Data.languages = {
